    ...
    return (
        <div className="bg-background text-on-surface selection:bg-primary-container selection:text-on-primary-container">
            <main className="max-w-container-max mx-auto px-margin-desktop pt-8 pb-section-gap">
                ...
                {/* Hero Section */}
                <section className="grid grid-cols-1 lg:grid-cols-12 gap-section-gap mb-section-gap items-start bg-white p-8 lg:p-12 rounded-[2.5rem] shadow-sm border border-outline-variant">
                    {/* Profile Image */}
                    <div className="lg:col-span-5 relative group">
                        ...
                        <img 
                            ...
                            className="w-full aspect-[4/5] object-cover rounded-[1.5rem] shadow-lg border-4 border-white" 
                    ...
                    <div className="lg:col-span-7 flex flex-col gap-6 lg:pl-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div className="p-4 rounded-xl bg-white border border-outline-variant flex items-center gap-4 hover:shadow-md transition-shadow">
